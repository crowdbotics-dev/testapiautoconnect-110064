...
## Project Structure
    ...
    ├── testapiautoconnect_110064  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_110064`
...
2. Clone this repo and `cd testapiautoconnect_110064`
